/**
 * Legacy Heroicon component names wired to the active theme icon pack.
 * Import from here instead of @heroicons/vue for live pack switching.
 */
import { defineComponent, h, inject } from 'vue'
import { getThemeIcon, ICON_REVISION_KEY } from './index'

function createThemedIcon(semanticName, displayName) {
