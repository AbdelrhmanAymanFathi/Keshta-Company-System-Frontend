      ...
      <div class="bg-white rounded-2xl border border-slate-200 shadow-xl w-full max-w-sm sm:max-w-lg lg:max-w-3xl p-4 sm:p-6 max-h-[90vh] overflow-y-auto">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <label>
            ...
            <input v-model="form.bankName" :placeholder="$t('suppliers.placeholders.bankName')" class="w-full px-3 py-2 border rounded theme-input-focus" />
          </label>
          <label>
        ...
        <div v-else>
          ...
          <div class="grid md:grid-cols-2 gap-4">
            <div>
              ...
              <div class="overflow-auto max-h-100 bg-white rounded border">
...
import { DocumentTextIcon, PencilSquareIcon, PlusIcon, WalletIcon, TrashIcon, XMarkIcon } from '@acme/icon-packs/legacy'
...
export default {
  ...
  components: { Pagination, DateField, DocumentTextIcon, PencilSquareIcon, PlusIcon, WalletIcon, TrashIcon, XMarkIcon },
  data() {
    return {
      q: '',
      modalOpen: false,
