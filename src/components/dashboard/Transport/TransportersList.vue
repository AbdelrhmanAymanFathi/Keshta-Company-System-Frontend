          ...
          >
            ...
            <td class="px-6 py-4">
              <div class="flex gap-3" :class="isRTL ? 'justify-start' : 'justify-end'">
                <button @click.stop="openStatement(c)" class="text-purple-600 hover:text-purple-800" :title="$t('transporters.statement')">
                  <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </button>
                <button @click.stop="openWallet(c)" class="text-blue-600 hover:text-blue-800" :title="$t('transporters.wallet')">
                  <svg class="h-5 w-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      >
        <div class="flex justify-between items-start" :class="isRTL ? 'flex-row-reverse' : ''">
          ...
          <div class="flex flex-col gap-3">
            <button @click.stop="openStatement(c)" class="text-purple-600 text-xs">{{ $t('transporters.statement') }}</button>
            <button @click.stop="openWallet(c)" class="text-blue-600 text-xs">{{ $t('transporters.wallet') }}</button>
