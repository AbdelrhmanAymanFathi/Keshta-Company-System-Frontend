<template>
    <div :dir="isRTL ? 'rtl' : 'ltr'" class="p-6">
      ...
      <div v-else-if="hasData" class="space-y-6">
        ...
        <!-- Detailed View -->
        <div v-if="activeModule && changes[activeModule]?.items?.length > 0" class="bg-white rounded-lg shadow-sm border overflow-hidden">
